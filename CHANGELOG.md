...
Import and export a binary representation of your mnemonic, in a format popularized by Tiny Seed metal plates. BIP39 mnemonic words number, ranging from 0 to 2047 are punched in binary format on a rectangular grid.
...
Also available in some metal plate backup formats, you could load your mnemonic words from its decimal BIP39 word number (0-2047), now you can also load from its hexadecimal(0x0-0x7FF) or octal(0-3777) word number.
