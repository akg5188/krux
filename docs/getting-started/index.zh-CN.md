...
5. [Amigo 直接烧录 maixpy.bin](installing/from-maixpy-bin.zh-CN.md)
6. [Amigo 商用交付说明](../amigo-commercial-release.zh-CN.md)
7. [Amigo 常见问题](../faq.zh-CN.md)
8. [Amigo TP / Web3 迁移计划与接手记录](../amigo-tp-web3-port-plan.zh-CN.md)
...
- 如果你已经在看 `maixpy.bin` 或只想维护底层镜像，先看第 5 条
