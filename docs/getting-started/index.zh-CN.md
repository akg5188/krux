...
4. [Amigo 固定快照重编译教程](installing/from-github-snapshot.zh-CN.md)
5. [Amigo 固定快照极速版](installing/from-github-snapshot-quick.zh-CN.md)
6. [Amigo 直接烧录 maixpy.bin](installing/from-maixpy-bin.zh-CN.md)
7. [Amigo 商用交付说明](../amigo-commercial-release.zh-CN.md)
8. [Amigo 常见问题](../faq.zh-CN.md)
9. [Amigo TP / Web3 迁移计划与接手记录](../amigo-tp-web3-port-plan.zh-CN.md)
...
- 如果你想复现这次已经验证过的 GitHub 快照，先看第 4 条
- 如果你只想照着最短步骤快速重编译，先看第 5 条
- 如果你在看助记词编号、钢板打孔数字或 TinySeed，记住统一口径都是 `0-2047`，位权从左到右是 `1 / 2 / 4 / ... / 1024`，扫描还原也跟手动输入用同一套映射
- 如果你已经在看 `maixpy.bin` 或只想维护底层镜像，先看第 6 条
...
- [Amigo 固定快照极速版](installing/from-github-snapshot-quick.zh-CN.md)
