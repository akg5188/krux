...
Display the BIP39 mnemonic word numbers (0-2047) in decimal, hex, or octal format.

These indices are zero-based throughout Krux: `0` is the first BIP39 word and `2047` is the last.
...
This metal backup format represents the BIP39 mnemonic word's numbers (0-2047). Each of the four digits is converted to a sum of 1, 2, 4 or 8. This option does not print even if a printer driver is set.
...
This metal backup format represents the BIP39 mnemonic word's numbers (0-2047) in binary format on a metal plate, where the 1's are marked (punched) and the 0's are left intact. You can also print your mnemonic in this format after setting up the thermal printer driver.
<div style="clear: both"></div>
