...
def test_capture_qr_code(mocker, multiple_devices, tdata):
    ...
    from krux.qr import FORMAT_PMOFN, FORMAT_RELAY, FORMAT_TP, FORMAT_UR
    ...
    cases = [
        ...
        [
            # TP multiFragment QR code
            [
                build_tp_multi_fragment_raw("hello web3", 0, 2, "hello "),
                build_tp_multi_fragment_raw("hello web3", 1, 2, "web3"),
            ],
            "hello web3",
            FORMAT_TP,
        ],
        [
            # TP relay QR code
            build_tpr1_pages("tp:personalSign-version=1.0&data=test", chunk_chars=12),
            "tp:personalSign-version=1.0&data=test",
            FORMAT_RELAY,
        ],
    ]
