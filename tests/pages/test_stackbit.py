...
def test_enter_stackbit(m5stickv, mocker):
    ...
    TEST_12_WORDS = "three wild laptop laptop laptop laptop laptop laptop laptop laptop laptop laptop"
...
def test_enter_stackbit_touch(amigo, mocker):
    ...
    TEST_12_WORDS = "laptop laptop laptop laptop laptop laptop laptop laptop laptop laptop laptop laptop"
