...
class MockStats:
    """Mock the luminosity of dots for the TinySeed `abandon...about` sample."""
    ...
    def median(self):
        ...
        self.counter += 1
        # Punch the final two cells so the last word becomes 3 in the 0-based scan.
        if self.counter in (122, 123):
            return PUNCHED
        return NON_PUNCHED
